...
function escolha(jogador) {
    ...
    document.querySelector('.choices').innerHTML = `Você <img class="move-icon" src="imagens/${jogador}-emoji.png"> <img class="move-icon" src="imagens/${computer}-emoji.png"> Computador`
}


function escolhaComputer() {
    const randomNumber = Math.random();
    return randomNumber < 1 / 3 ? 'pedra' :
           randomNumber < 2 / 3 ? 'papel' :
           'tesoura';
}
