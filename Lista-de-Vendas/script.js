...
function cadastrar() {
    ...
    valoresAdicionados.push({ detergente, cloro, sabao, desinfetante})  // Armazena os valores para remoção correta
    calculoTotal(detergente, cloro, sabao, desinfetante)
}


function calculoTotal(detergente, cloro, sabao, desinfetante) {
